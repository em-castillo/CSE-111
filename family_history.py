'''Week 08 Team Activity - Dictionaries'''
...
def print_death_age(people_dict):
    ...
    for key, value in people_dict.items():
        ...
        # inside loop to print the whole list
        print(f'{name} {age_death}')
...
def count_genders(people_dict):
    ...
    # outside loop to count total and not print the long of list
...
def print_marriages(marriages_dict, people_dict):
    ...
    for key, value in marriages_dict.items():
        ...
        age_male = wedding_year - husband_birth
        age_female = wedding_year - wife_birth

        # inside loop to print all
        print(f'{husband_name} {age_male} > {wedding_year} < {wife_name} {age_female}')


# stretch given by teacher it doesn't print
