...
def main():
    ...
    ex_radius = 2.8
    ex_height = 3.2
    # arguments added. They are in the same function
    ...
    vol = cone_volume(radius, height)  # arguments added
...
def cone_volume(radius, height):  # parameters added that match line 38
