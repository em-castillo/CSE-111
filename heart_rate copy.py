...
def populate_main_window(frm_main):
    ...
    area_output = tk.Label(frm_main, width=4)
    # lbl_height = tk.Label(frm_main, width=4)
    ...
    area_output.grid(row=0, column=5, padx=3, pady=3)
    # lbl_height.grid(row=0, column=4, padx=3, pady=3)
    ...
    def calc(event):
        ...
        try:
            ...
            area = width * height
            area_output.config(text=f"{area:.0f}")

        except ValueError:
            area_output.config(text="")
