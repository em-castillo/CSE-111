...
def main():
    ...
    # TODO: Check if the vin is a key that is in the vehicles dictionary.
    if vin in vehicles:

        # TODO: Find the data for the vehicle that the user wants.
        value = vehicles[vin]

        # TODO: Print the manufacturer, model, and color of the vehicle.
        # TODO: Don't print the year, engine design, or displacement.
        ...
        print(f"That {vin} is not in the dictionary.")
