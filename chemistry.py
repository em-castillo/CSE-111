...
def make_periodic_table():
    # create and return a compound list
    periodic_table_dict = {
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    #   Add the product into the total mass.
        total += total_mass  # added because it only kept last loop result
...
def main():
    ...
    # extra
    molecules_dict = get_known_molecules()
    formula_name = get_formula_name(formula, molecules_dict)
    print(f'{formula_name}')


# If this file was executed then call the main function.
